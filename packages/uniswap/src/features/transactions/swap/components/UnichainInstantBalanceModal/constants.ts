...
export const CHAIN_TO_UNIVERSAL_ROUTER_ADDRESS: Partial<Record<UniverseChainId, string[]>> = {
  ...
  // HashKey chains use V3SwapRouter instead of Universal Router
  [UniverseChainId.HashKeyTestnet]: [
    '0x46cBccE3c74E95d1761435d52B0b9Abc9e2FEAC0', // V3SwapRouter address for HashKey Testnet (chainId 133)
  ],
  // TODO: Replace with actual HashKey Mainnet V3SwapRouter address when available
